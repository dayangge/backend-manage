...
@Form.create()
class SystemGameMobile extends PureComponent {
  state = {
    selectedRows: [],
    row: '',
...
export default SystemGameMobile;
    ...
    return (
      <div>
        <Form layout="vertical">
          <FormItem label="游戏标识" {...formItemLayout}>
          ...
          <FormItem label="模块版本号" {...formItemLayout}>
          ...
          <FormItem label="游戏归属" {...formItemLayout}>
            {getFieldDecorator('gameMode', {})(
              <CheckboxGroup>
                <Checkbox value={0}>房卡</Checkbox>
                <Checkbox value={1}>金币</Checkbox>
              </CheckboxGroup>
            )}
          </FormItem>
          <FormItem label="游戏归属" {...formItemLayout}>
            {getFieldDecorator('gameFrom', {})(
              <CheckboxGroup>
                <Checkbox value={0}>IOS</Checkbox>
                <Checkbox value={1}>Android</Checkbox>
              </CheckboxGroup>
            )}
          </FormItem>
