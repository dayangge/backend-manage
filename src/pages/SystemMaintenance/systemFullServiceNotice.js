...
class SystemMachineManage extends PureComponent {
  ...
  render() {
    ...
    return (
      <PageHeaderWrapper title="全服通告管理">
        <Card bordered={false}>
    ...
    return (
      <div>
        <Form layout="vertical">
          <FormItem label="游戏" {...formItemLayout}>
            {getFieldDecorator('name', {})(<Input />)}
          </FormItem>
          <FormItem label="金币" {...formItemLayout}>
        ...
        <Form layout="vertical">
          <FormItem label="游戏" {...formItemLayout}>
            {getFieldDecorator('game', {})(
              <Select>
                <Option value={1}>看牌牛牛</Option>
                <Option value={2}>中发白</Option>
                <Option value={3}>百人牌九</Option>
                <Option value={4}>百家乐</Option>
                <Option value={5}>龙凤斗</Option>
                <Option value={6}>不洗牌都地主</Option>
                <Option value={7}>红黑大战</Option>
                <Option value={8}>水果拉霸</Option>
                <Option value={9}>李逵</Option>
                <Option value={10}>蛟龙出海</Option>
                <Option value={11}>时时彩</Option>
              </Select>
            )}
          </FormItem>
          <FormItem label="金币" {...formItemLayout}>
            {getFieldDecorator('gold', {})(<Input />)}
          </FormItem>
        </Form>
      </div>
    );
